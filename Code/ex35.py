...
def gold_room():
    ...
    if how_much < 50:
        ...
        # Exit from the program withput error hence 0 => exit(0)
        # Exit from the program with error hence =
        exit(0)
    else:
...
def start():
    ...
    if choice == "left":
        ...
        dead("Thats not the right choice.!!!")
